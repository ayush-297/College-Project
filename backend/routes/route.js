...
import { teacherRegister, teacherLogIn, getTeachers, getTeacherDetail, deleteTeachers, deleteTeachersByClass, deleteTeacher, updateTeacherSubject, teacherAttendance, markAttendance, getTeacherStudentsAttendance } from '../controllers/teacher-controller.js';
...
router.post('/TeacherStudentsAttendance/:id', markAttendance);
router.get('/TeacherStudentsAttendance/:id', getTeacherStudentsAttendance);
