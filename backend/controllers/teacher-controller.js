...
export const getTeacherStudentsAttendance = async (req, res) => {
  try {
    const { id } = req.params;

    const teacher = await Teacher.findById(id)
      .populate("attendance.students.studentId", "name rollNum") // Only get student name and email
      .lean();
    ...
    const attendanceByDate = teacher.attendance.map((record) => ({
      date: record.date,
